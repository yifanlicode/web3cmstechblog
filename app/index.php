...
<div class="container-fluid my-5">
  <div class="row justify-content-center">
    <div class="col-md-8 col-lg-6 text-center">
      <h6 class="display-6 mb-4 text-center" style="white-space: nowrap;">Welcome to Web3 Launchpad</h6>
    ...
    <div class="col-lg-9">
      ...
      <?php if (isset($_SESSION['user_id'])) : ?>
        ...
        <select class="form-select-sm rounded-pill border-0" id="sort-by-select" onchange="sortPosts(this.value)">
          <option value="update_date" <?php if ($sort == '' || $sort == 'update_date') echo 'selected' ?>>Update Date</option>
          ...
          <option value="post_views_count" <?php if ($sort == 'post_views_count') echo 'selected' ?>>Views</option>
        </select>
      </div>
      <?php endif; ?>
